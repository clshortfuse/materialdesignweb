declare const _default: {
    new (...args: any[]): {
        ...
        readonly static: typeof CustomElement;
        ...
        src: string;
        badge: string;
        _anchorAriaCurrent(this: CustomElement & {
            delegatesFocus: boolean;
        } & {
            href: string;
            target: string;
        ...
        _anchorAriaLabelledby(this: CustomElement & {
            delegatesFocus: boolean;
        } & {
            href: string;
            target: string;
        ...
        _anchorHref(this: CustomElement & {
            delegatesFocus: boolean;
        } & {
            href: string;
            target: string;
    ...
    overrides: <CLASS_1 extends typeof CustomElement, ARGS_1 extends ConstructorParameters<CLASS_1>, INSTANCE_1 extends InstanceType<CLASS_1>, PROPS_1 extends Partial<INSTANCE_1>>(this: CLASS_1, source: PROPS_1 & ThisType<PROPS_1 & INSTANCE_1>, options?: Partial<PropertyDescriptor>) => CLASS_1 & (new (...args: ARGS_1) => INSTANCE_1 & PROPS_1);
    ...
    idl: typeof CustomElement.prop;
    _addCallback<T_6 extends typeof CustomElement, K_18 extends keyof T_6>(this: T_6, collection: K_18, callback: T_6[K_18] extends (infer R_3)[] ? R_3 : never): void;
    append<T_7 extends typeof CustomElement>(this: T_7, ...parts: import("../core/Composition.js").CompositionPart<T>[]): T_7;
    recompose<T1 extends typeof CustomElement, T2_1 extends InstanceType<T1>, T3 extends import("../core/CustomElement.js").CompositionCallback<T2_1, T2_1 & T1["schema"]>["composed"]>(this: T1, callback: T3): T1;
    css<T1_1 extends typeof CustomElement, T2_2 extends string | TemplateStringsArray | CSSStyleSheet | HTMLStyleElement>(this: T1_1, array: T2_2, ...rest: T2_2 extends string ? any : T2_2 extends TemplateStringsArray ? any[] : (CSSStyleSheet | HTMLStyleElement)[]): T1_1;
    setSchema<T1_2 extends typeof CustomElement, T2 extends {
        [x: string]: unknown;
    }>(this: T1_2, schema: T2): T1_2 & {
        schema: T2;
    };
    schema: T2;
    autoRegister<T_8 extends typeof CustomElement>(this: T_8, elementName: string): T_8;
    html<T_9 extends typeof CustomElement>(this: T_9, string: TemplateStringsArray, ...substitutions: (string | Element | ((this: InstanceType<T_9>, data: InstanceType<T_9> & T_9["schema"], injections?: any) => any))[]): T_9;
    extend<T1_3 extends typeof CustomElement, T2_3 extends T1_3>(this: T1_3, customExtender?: (Base: T1_3) => T2_3): T2_3;
    setStatic<T1_4 extends typeof CustomElement, T2_4 extends {
        [x: string]: string | number | boolean | object | any[] | ((this: T1_4, ...args: any[]) => any);
    }>(this: T1_4, source: T2_4 & ThisType<T1_4 & T2_4>): T1_4 & T2_4;
    readonly<CLASS_3 extends typeof CustomElement, ARGS_3 extends ConstructorParameters<CLASS_3>, INSTANCE_3 extends InstanceType<CLASS_3>, PROPS_2 extends object>(this: CLASS_3, source: PROPS_2 & ThisType<PROPS_2 & INSTANCE_3>, options?: Partial<PropertyDescriptor>): CLASS_3 & (new (...args: ARGS_3) => INSTANCE_3 & PROPS_2);
    set<CLASS_4 extends typeof CustomElement, ARGS_4 extends ConstructorParameters<CLASS_4>, INSTANCE_4 extends InstanceType<CLASS_4>, PROPS_3 extends object>(this: CLASS_4, source: PROPS_3 & ThisType<PROPS_3 & INSTANCE_4>, options?: Partial<PropertyDescriptor>): CLASS_4 & (new (...args: ARGS_4) => INSTANCE_4 & PROPS_3);
    ...
    register<T_10 extends typeof CustomElement>(this: T_10, elementName?: string, force?: boolean): T_10;
    ...
    define<CLASS_6 extends typeof CustomElement, ARGS_7 extends ConstructorParameters<CLASS_6>, INSTANCE_6 extends InstanceType<CLASS_6>, PROPS_4 extends {
        [x: string]: {
            enumerable?: boolean;
    ...
    undefine(name: any): typeof CustomElement;
    ...
    defineStatic<T1_5 extends typeof CustomElement, T2_5 extends import("../core/CustomElement.js").IDLParameter<T1_5>>(this: T1_5, props: T2_5): T1_5 & import("../core/CustomElement.js").ParsedProps<T2_5>;
    events<T_11 extends typeof CustomElement>(this: T_11, listeners?: import("../core/Composition.js").CompositionEventListenerObject<InstanceType<T_11>>, options?: Partial<import("../core/Composition.js").CompositionEventListener<InstanceType<T_11>, string>>): T_11;
    childEvents<T_12 extends typeof CustomElement>(this: T_12, listenerMap: {
    ...
    rootEvents<T_11 extends typeof CustomElement>(this: T_11, listeners?: import("../core/Composition.js").CompositionEventListenerObject<InstanceType<T_11>>, options?: Partial<import("../core/Composition.js").CompositionEventListener<InstanceType<T_11>, string>>): T_11;
    on<T1_6 extends typeof CustomElement, T2_6 extends InstanceType<T1_6>, T3_1 extends import("../core/CustomElement.js").CompositionCallback<T2_6, T2_6 & T1_6["schema"]>, T4 extends keyof T3_1>(this: T1_6, name: T3_1 | T4, callbacks?: T3_1[T4] & ThisType<T2_6>): T1_6;
    onPropChanged<T1_7 extends typeof CustomElement, T2_7 extends InstanceType<T1_7>>(this: T1_7, options: import("../core/CustomElement.js").ObjectOrObjectEntries<{ [P in keyof T2_7]?: (this: T2_7, oldValue: T2_7[P], newValue: T2_7[P], changes: any, element: T2_7) => void; }>): T1_7;
    onAttributeChanged<T1_8 extends typeof CustomElement, T2_8 extends InstanceType<T1_8>>(this: T1_8, options: {
