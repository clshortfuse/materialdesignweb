declare const _default: {
    new (...args: any[]): {
        ...
        src: string;
        badge: string;
        _anchorAriaCurrent({ active }: CustomElement & {
            delegatesFocus: boolean;
        } & {
            href: string;
            target: string;
        ...
        _anchorAriaLabelledby({ ariaLabel }: CustomElement & {
            delegatesFocus: boolean;
        } & {
            href: string;
            target: string;
        ...
        _anchorHref({ href }: CustomElement & {
            delegatesFocus: boolean;
        } & {
            href: string;
            target: string;
    ...
    recompose<T1 extends typeof CustomElement, T2 extends InstanceType<T1>, T3 extends import("../core/CustomElement.js").CompositionCallback<T2, T2>["composed"]>(this: T1, callback: T3): T1;
    css<T1_1 extends typeof CustomElement, T2_1 extends string | TemplateStringsArray | CSSStyleSheet | HTMLStyleElement>(this: T1_1, array: T2_1, ...rest: T2_1 extends string ? any : T2_1 extends TemplateStringsArray ? any[] : (CSSStyleSheet | HTMLStyleElement)[]): T1_1;
    autoRegister<T_8 extends typeof CustomElement>(this: T_8, elementName: string): T_8;
    html<T_9 extends typeof CustomElement>(this: T_9, string: TemplateStringsArray, ...substitutions: (string | Element | ((this: InstanceType<T_9>, data: InstanceType<T_9>, injections?: any) => any))[]): T_9;
    extend<T1_2 extends typeof CustomElement, T2_2 extends T1_2>(this: T1_2, customExtender?: (Base: T1_2) => T2_2): T2_2;
    setStatic<T1_3 extends typeof CustomElement, T2_3 extends {
        [x: string]: string | number | boolean | object | any[] | ((this: T1_3, ...args: any[]) => any);
    }>(this: T1_3, source: T2_3 & ThisType<T1_3 & T2_3>): T1_3 & T2_3;
    readonly<CLASS_3 extends typeof CustomElement, ARGS_3 extends ConstructorParameters<CLASS_3>, INSTANCE_3 extends InstanceType<CLASS_3>, PROPS_2 extends object>(this: CLASS_3, source: PROPS_2 & ThisType<PROPS_2 & INSTANCE_3>, options?: Partial<PropertyDescriptor>): CLASS_3 & import("../core/CustomElement.js").Class<PROPS_2, ARGS_3>;
    set<CLASS_4 extends typeof CustomElement, ARGS_4 extends ConstructorParameters<CLASS_4>, INSTANCE_4 extends InstanceType<CLASS_4>, PROPS_3 extends object>(this: CLASS_4, source: PROPS_3 & ThisType<PROPS_3 & INSTANCE_4>, options?: Partial<PropertyDescriptor>): CLASS_4 & import("../core/CustomElement.js").Class<PROPS_3, ARGS_4>;
    mixin<BASE extends typeof CustomElement, FN extends (...args: any[]) => any, RETURN extends ReturnType<FN>, SUBCLASS extends RETURN>(this: BASE, mixin: FN): SUBCLASS & BASE;
    ...
    define<CLASS_6 extends typeof CustomElement, ARGS_6 extends ConstructorParameters<CLASS_6>, INSTANCE_6 extends InstanceType<CLASS_6>, PROPS_4 extends {
        [x: string]: {
            enumerable?: boolean;
    ...
    defineStatic<T1_4 extends typeof CustomElement, T2_4 extends import("../core/CustomElement.js").IDLParameter<T1_4>>(this: T1_4, props: T2_4): T1_4 & import("../core/CustomElement.js").ParsedProps<T2_4>;
    ...
    on<T1_5 extends typeof CustomElement, T2_5 extends InstanceType<T1_5>, T3_1 extends import("../core/CustomElement.js").CompositionCallback<T2_5, T2_5>, T4 extends keyof T3_1>(this: T1_5, name: T3_1 | T4, callbacks?: T3_1[T4] & ThisType<T2_5>): T1_5;
    onPropChanged<T1_6 extends typeof CustomElement, T2_6 extends InstanceType<T1_6>>(this: T1_6, options: import("../core/CustomElement.js").ObjectOrObjectEntries<{ [P in keyof T2_6]?: (this: T2_6, oldValue: T2_6[P], newValue: T2_6[P], changes: any, element: T2_6) => void; }>): T1_6;
    onAttributeChanged<T1_7 extends typeof CustomElement, T2_7 extends InstanceType<T1_7>>(this: T1_7, options: {
