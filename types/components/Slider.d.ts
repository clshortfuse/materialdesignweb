declare const _default: typeof CustomElement & import("../core/CustomElement.js").Class<{
    ...
    computeTrackStyle({ ticks, _valueAsText, min, max }: CustomElement & {
        delegatesFocus: boolean;
    } & {
        disabled: boolean;
        focused: boolean;
    ...
    _thumbLabelHidden({ _isHoveringThumb, focusedState }: CustomElement & {
        delegatesFocus: boolean;
    } & {
        disabled: boolean;
        focused: boolean;
    ...
    _computedThumbLabel({ thumbLabel, _valueAsText }: CustomElement & {
        delegatesFocus: boolean;
    } & {
        disabled: boolean;
        focused: boolean;
