...
init_polyfills();
var contents = `/* components/Container.css */
:host {
...
attachIDLs_fn = /* @__PURE__ */ __name(function() {
  ...
  for (const key of component.idlBooleanAttributes) {
    const propName = _CustomElement.attrNameToPropName(key);
...
__publicField(CustomElement, "idlBooleanAttributes", []);
__publicField(CustomElement, "idlIntegerAttributes", []);
__publicField(CustomElement, "idlFloatAttributes", []);
__publicField(CustomElement, "idlStringAttributes", []);
...
// components/Text.css
init_polyfills();
var contents2 = `/* components/Text.css */
:host {
...
var Text = _Text;
__name(Text, "Text");
__publicField(Text, "idlBooleanAttributes", [
  ...__superGet(_Text, _Text, "idlBooleanAttributes"),
  "block"
]);
__publicField(Text, "idlStringAttributes", [
  ...__superGet(_Text, _Text, "idlStringAttributes"),
  "ink",
  "type-style"
]);
...
__publicField(Container, "idlBooleanAttributes", [
  ...__superGet(_Container, _Container, "idlBooleanAttributes"),
  "disabled",
  "shape-top",
  "shape-bottom",
  "shape-start",
...
__publicField(Container, "idlIntegerAttributes", [
  ...__superGet(_Container, _Container, "idlIntegerAttributes"),
  "elevation"
]);
__publicField(Container, "idlStringAttributes", [
  ...__superGet(_Container, _Container, "idlStringAttributes"),
  "color",
  "bg",
  "shape-style"
]);
...
init_polyfills();
var contents3 = `/* components/BottomAppBar.css */
:host {
  --mdw-container__elevation__opacity: var(--mdw-container__elevation__opacity__2);
  display: flex;
  align-items: center;
...
var BottomAppBar_default = styles3;
...
init_polyfills();
var contents5 = `/* components/Input.css */
:host {
...
init_polyfills();
var contents6 = `/* components/Overlay.css */
:host {
  position: relative;
  outline: none;
  -webkit-tap-highlight-color: transparent;
...
var _Overlay = class extends Container {
  ...
  connectedCallback() {
    this.addEventListener("mousedown", _Overlay.onMouseDown, { passive: true });
    this.addEventListener("touchstart", _Overlay.onTouchStart, { passive: true });
    this.addEventListener("keydown", _Overlay.onKeyDown, { passive: true });
    this.addEventListener("blur", _Overlay.onBlur, { passive: true });
    this.addEventListener("focus", _Overlay.onFocus, { passive: true });
  }
  disconnectedCallback() {
    this.removeEventListener("mousedown", _Overlay.onMouseDown);
    this.removeEventListener("touchstart", _Overlay.onTouchStart);
    this.removeEventListener("keydown", _Overlay.onKeyDown);
    this.removeEventListener("blur", _Overlay.onBlur);
    this.removeEventListener("focus", _Overlay.onFocus);
  }
};
...
init_polyfills();
var contents7 = `/* components/Ripple.css */
:host {
  --enter-delay: 80ms;
...
var _Ripple = class extends Overlay {
  ...
  connectedCallback() {
    ...
    this.addEventListener("click", _Ripple.onClick, { passive: true });
    this.addEventListener("mousedown", _Ripple.onMouseDown, { passive: true });
    this.addEventListener("touchstart", _Ripple.onTouchStart, { passive: true });
    this.addEventListener("keydown", _Ripple.onKeyDown, { passive: true });
    this.innerElement.addEventListener("animationend", _Ripple.onAnimationEnd, { passive: true });
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    this.removeEventListener("click", _Ripple.onClick);
    this.removeEventListener("mousedown", _Ripple.onMouseDown);
    this.removeEventListener("touchstart", _Ripple.onTouchStart);
    this.removeEventListener("keydown", _Ripple.onKeyDown);
  }
};
var Ripple = _Ripple;
...
__publicField(Input, "idlBooleanAttributes", [
  ...__superGet(_Input, _Input, "idlBooleanAttributes")
]);
...
__publicField(Input, "idlStringAttributes", [
  ...__superGet(_Input, _Input, "idlStringAttributes"),
  "aria-controls"
]);
...
__publicField(Button, "idlBooleanAttributes", [
  ...__superGet(_Button, _Button, "idlBooleanAttributes"),
  "elevated",
  "filled",
  "outlined"
]);
__publicField(Button, "idlStringAttributes", [
  ...__superGet(_Button, _Button, "idlStringAttributes"),
  "icon",
  "src"
]);
...
// components/Card.css
init_polyfills();
var contents8 = `/* components/Card.css */
:host {
...
init_polyfills();
var contents9 = `/* components/CardActionArea.css */
:host {
  position: relative;
...
var CardActionArea_default = styles9;
...
// components/Chip.css
init_polyfills();
var contents10 = `/* components/Chip.css */
:host {
  --mdw-ink: var(--mdw-color__primary);
  --mdw-shape__size: 8px;
  --mdw-button__icon__size: 18px;
...
var Chip = _Chip;
__name(Chip, "Chip");
__publicField(Chip, "idlBooleanAttributes", [
  ...__superGet(_Chip, _Chip, "idlBooleanAttributes"),
  "suggestion"
]);
...
init_polyfills();
var contents11 = `/* components/Dialog.css */
:host {
...
__publicField(Dialog, "idlBooleanAttributes", [
  ...__superGet(_Dialog, _Dialog, "idlBooleanAttributes"),
  "open"
]);
__publicField(Dialog, "idlStringAttributes", [
  ...__superGet(_Dialog, _Dialog, "idlStringAttributes"),
  "title",
  "description",
  "icon",
  "default",
...
init_polyfills();
var contents12 = `/* components/Divider.css */
:host {
  inline-size: 100%;
...
init_polyfills();
var contents13 = `/* components/ExtendedFab.css */
:host {
...
var ExtendedFab_default = styles13;
...
__publicField(ExtendedFab, "idlBooleanAttributes", [
  ...__superGet(_ExtendedFab, _ExtendedFab, "idlBooleanAttributes"),
  "lowered"
]);
...
// components/Fab.css
init_polyfills();
var contents14 = `/* components/Fab.css */
:host {
  --mdw-shape__size: 16px;
  --mdw-fab__elevation__opacity: var(--mdw-container__elevation__opacity__3);
  --mdw-fab__box-shadow: var(--mdw-container__box-shadow__3);
...
var Fab = _Fab;
__name(Fab, "Fab");
__publicField(Fab, "idlStringAttributes", [
  ...__superGet(_Fab, _Fab, "idlStringAttributes"),
  "size"
]);
...
init_polyfills();
var contents15 = `/* components/FilterChip.css */
:host {
  --mdw-ink: var(--mdw-color__on-secondary-container);
  --mdw-bg: var(--mdw-color__secondary-container);
...
var FilterChip_default = styles15;
...
// components/Icon.css
init_polyfills();
var contents16 = `/* components/Icon.css */
:host {
  --mdw-icon__size: 18px;
  --mdw-icon__opacity: 1;
...
__publicField(Icon, "observedAttributes", [
  ...__superGet(_Icon, _Icon, "observedAttributes"),
  "icon",
  ..._Icon.imageElementAttributes
]);
...
__publicField(MenuItem, "idlStringAttributes", [
  ...__superGet(_MenuItem, _MenuItem, "idlStringAttributes"),
  "icon",
  "src",
  "trailing",
  "trailing-icon",
...
__publicField(Menu, "idlBooleanAttributes", [
  ...__superGet(_Menu, _Menu, "idlBooleanAttributes"),
  "open"
]);
__publicField(Menu, "idlStringAttributes", [
  ...__superGet(_Menu, _Menu, "idlStringAttributes"),
  "direction",
  "position"
]);
...
init_polyfills();
var contents20 = `/* components/NavBar.css */
:host {
  --mdw-container__elevation__opacity: var(--mdw-container__elevation__opacity__2);
  display: flex;
  align-items: center;
...
var NavBar_default = styles20;

// components/NavBar.js
var _NavBar = class extends Container {
};
var NavBar = _NavBar;
__name(NavBar, "NavBar");
__publicField(NavBar, "ariaRole", "navigation");
__publicField(NavBar, "elementName", "mdw-navbar");
...
init_polyfills();
var contents21 = `/* components/SegmentedButton.css */
:host {
  --mdw-shape__size: 0;
  --mdw-button__icon__font-variation-settings: "FILL" 0;
  --mdw-button__outline__size: 1px;
...
var SegmentedButton_default = styles21;
...
init_polyfills();
var contents22 = `/* components/SegmentedButtonGroup.css */
:host {
  --mdw-bg: var(--mdw-color__secondary-container);
  --mdw-ink: var(--mdw-color__on-secondary-container);
  display: flex;
...
var SegmentedButtonGroup_default = styles22;
