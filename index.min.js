...
:host {
  ...
  grid-template: "a" minmax(32px, 1fr) / auto;
...
#badge {
  ...
  transform: var(--mdw-nav-item__badge__transform, translateY(-50%) translateX(4px) translateY(-8px) scale(var(--mdw-badge__scale)));
  z-index: 4;
...
:host[show-label=active]:not([active]) {
}`;
var styles21;
try {
...
#slot::slotted(mdw-nav-item) {
  ...
  --mdw-nav-item__badge__background-color: transparent;
...
// components/NavDrawer.js
var _NavDrawer = class extends Nav {
};
...
init_polyfills();
var contents25 = `/* components/SegmentedButton.css */
:host {
  --mdw-shape__size: 0;
  --mdw-button__icon__font-variation-settings: "FILL" 0;
  --mdw-button__outline__size: 1px;
...
var SegmentedButton_default = styles25;
...
init_polyfills();
var contents26 = `/* components/SegmentedButtonGroup.css */
:host {
  --mdw-bg: var(--mdw-color__secondary-container);
  --mdw-ink: var(--mdw-color__on-secondary-container);
  display: flex;
...
var SegmentedButtonGroup_default = styles26;
