...
storeIdl_fn = function(key, value, stringValue) {
  const tuple = __privateMethod(this, _getIdlValue, getIdlValue_fn).call(this, key);
  tuple[0] = value;
  tuple[1] = stringValue;
};
_getIdlValue = new WeakSet();
getIdlValue_fn = function(key) {
...
lightFromCorePalette_fn = function(core) {
...
darkFromCorePalette_fn = function(core) {
