...
var _MDWInput = class extends MDWRipple {
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    ...
    if (name === "aria-controls" || _MDWInput.idlInputElementAttributes.includes(name)) {
      if (newValue == null) {
        this.inputElement?.removeAttribute(name);
      } else {
        this.inputElement?.setAttribute(name, newValue);
...
__publicField(MDWInput, "idlStringAttributes", [
  ...__superGet(_MDWInput, _MDWInput, "idlStringAttributes"),
  "aria-controls"
]);
