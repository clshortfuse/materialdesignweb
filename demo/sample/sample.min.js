...
var CustomElement = class _CustomElement extends HTMLElement {
   ...
   *        : PROPS[KEY] extends ObserverPropertyType ? import('./observe.js').ParsedObserverPropertyType<PROPS[KEY]>
   *        : PROPS[KEY] extends {type: 'object'} & ObserverOptions<any, infer R> ? (unknown extends R ? object : R)
   *        : PROPS[KEY] extends {type: ObserverPropertyType} ? import('./observe.js').ParsedObserverPropertyType<PROPS[KEY]['type']>
   ...
   *  (
   *    this: T,
   *    listeners?: import('./Composition.js').CompositionEventListenerObject<InstanceType<T>>,
   *    options?: Partial<import('./Composition.js').CompositionEventListener<InstanceType<T>>>,
   *  ): T;
   * }}
   */
   ...
   *    this: T,
   *    listenerMap: {
   *      [P in keyof any]: import('./Composition.js').CompositionEventListenerObject<InstanceType<T>>
   *    },
   *    options?: Partial<import('./Composition.js').CompositionEventListener<InstanceType<T>>>,
   *  ): T;
   * }}
